...
Si vous préférez optifine, rendez-vous donc sur l'autre version de l'instance: 
...
|:---:|:---:|:---:|
| [Optifine](https://optifine.net/home) | Mod d'optimisation et d'amélioration du rendu |  |
| [Optifabric](https://www.curseforge.com/minecraft/mc-mods/optifabric) | Optimise optifine avec fabrique, le rend compatible |  |
...
| [Stendhal](https://www.curseforge.com/minecraft/mc-mods/stendhal) | Permet une meilleur édition des textes dans différents champs de minecraft (chat, livres, enclumes... ect). | Bugs connus sur le mod. Pour la pluart de ces bugs, un contournement est possible. |